...
<issue>
O backend foi implementado porém o frontend não foi
</issue>

<instructions>
  1. Implemente as novas regras no frontend.
  
  2. Documente a implementação no arquivo docs\changelog\04_category_management\06_refactor_add_subcategory_logic\implementação.md. No mesmo arquivo dê sugestões de mensagem para o commit usando boas práticas de Git.
</instructions>
