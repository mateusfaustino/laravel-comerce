...
<issue>
Nas telas de editar de produto (/admin/products/{id}) e detalhe de produto (/admin/products/{id}), não está aparcendo as fotos do produto. Apesar de haver fotos, não está aparecendo ao editar ou ver detalhes do produto
</issue>
