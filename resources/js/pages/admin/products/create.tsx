...
export default function ProductsCreate({ categories, subcategories }: Props) {
                    ...
                    <Card className="max-w-3xl">
                        ...
                        <CardContent className="flex flex-col gap-3">
                            ...
                            {categories.map((category) => {
                                ...
                                const allChildrenSelected = children.length > 0 && children.every((sub) => data.category_ids.includes(sub.id));
